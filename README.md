...
Note: You can download the Power App from [here](./PowerAppAdventCalendar/Adventcalendar.zip) and import it into your own environment. The app can then be used and analyzed.
...
Build the app yourself or download the Power App [PowerAppAdventCalendar](./PowerAppAdventCalendar/Adventcalendar.zip), import the app, and adapt it as needed. Of course, the advent calendar can still be expanded, for example with additional logic, falling snowflakes and more. I hope this article provides helpful tips and helps with creating your own apps.
